	...
	<div class="container-wrap">
		<aside id="fh5co-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(../sources/neat/images/img_bg_3.jpg);">
                    ...
                    <div class="col-md-12 text-center">
                        <form method="post" action="../Registro">
                            <div class="form-group">
                              ...
                              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingresa tu dirección de correo electrónico">
